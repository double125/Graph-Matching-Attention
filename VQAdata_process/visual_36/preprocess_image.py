...
def features_to_zarr(phase):
    ...
    if phase == 'trainval':
        infiles = [
            'visual_36/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv',
        ]
    elif phase == 'test':
        infiles = [
            'visual_36/test2015_36/test2015_resnet101_faster_rcnn_genome_36.tsv',
        ]
    else:
    ...
    pickle.dump(visual_graph, open('../VQA/visual_graph/vg_36/' + phase +'_visual_graph_1_03.pkl', 'wb'))
...
if __name__ == '__main__':
    ...
    save_dir = '../VQA/visual_graph/vg_36/'
